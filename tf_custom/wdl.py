...
x = {
    ...
    'sparse_feature_1': np.array([0, 0, 0, 0, 0, 0, 0, 0]),
...
sparse_feature_1_emb = layers.Embedding(1, 1,
                                        embeddings_initializer=tf.keras.initializers.RandomNormal(mean=0.0,
                                                                                                  stddev=0.0001,
                                                                                                  seed=2020),
                                        embeddings_regularizer=tf.keras.regularizers.l2(l2_reg),
...
deep_sparse_input = layers.Concatenate(axis=-1)(
    [deep_sparse_feature_0_emb(input_features['sparse_feature_0']),
     deep_sparse_feature_0_emb(input_features['sparse_feature_1'])])
...
final_logit = layers.add([dnn_logit, linear_logit])
...
model.save_weights('wdl/weights.ckpt')
